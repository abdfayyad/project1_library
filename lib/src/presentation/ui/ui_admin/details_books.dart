...
class Details extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions:MyApp.isadminn==true? [
          IconButton(onPressed: () {

             Navigator.push(context, MaterialPageRoute(
                 builder: (context) => AddBooks(book: book, isUpdate: true,)));
  ...
  void  delete(String id)async{
    ...
    var request = http.Request('DELETE', Uri.parse('http://192.168.34.221:8000/api/admin-panel/books/$id'));
    request.bodyFields = {};
